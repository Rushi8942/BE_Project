document.addEventListener('DOMContentLoaded', function () {
  ...
  function calculateInflatedPrice(currentPrice, yearsRemaining) {
      ...
      const annual=12*inflatedPrice;
      return annual.toFixed(2); // Limiting to 2 decimal places
  }
  ...
  function calculateSIPAmount(inflatedPrice, yearsRemaining, investmentType) {
      ...
      switch (investmentType) {
          ...
          case 'Index':
              ...
              break;
          default:
              interestRate = 0.01; // Default interest rate if no type is selected
      }
  ...
  const retirement = document.getElementById('retirement-form');
  ...
  retirement.addEventListener('submit', function (event) {
