document.addEventListener('DOMContentLoaded', function () {
 ...
 // Function to update HTML element with fund data
 function updateHTMLWithFundData(fundData) {
    ...
    const houseBuyingForm = document.getElementById('house-buying-form');
    ...
    houseBuyingForm.addEventListener('submit', function (event) {
